                ...
                <div class="card">
                    ...
                    <div class="card-header text-center">
                        <a href="#" class="logo mx-auto">
                            <img src="{{ asset('img/PTGACC.png') }}" alt="logo">
                        </a>
                        <div class="card-header-text" set-lan="html:We are the future of gaming" style="font-size: 16pt;">We are the future of ACC</div>
                    </div>
                    <div class="card-body">
